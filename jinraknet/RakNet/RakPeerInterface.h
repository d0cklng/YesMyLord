...
public:
    ...
    /// Send a real clean udp packet with no any raknet head.
    virtual bool SendRawUDP(const char *host, unsigned short remotePort, const char *data, BitSize_t dataLength, unsigned connectionSocketIndex=0 )=0;
